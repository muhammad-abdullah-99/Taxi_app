...
<div class="page-title">
    <div class="row">
        <div class="col-sm-6">
            <h4 class="mb-0"> نقاط البيع والتحويل البنكي</h4>
        </div>
        <!-- <div class="col-sm-6">
...
<div class="d-flex flex-wrap gap-2 mb-3">
    <form method="GET" action="{{ route('getPointAndBank') }}">
        <input type="hidden" name="bank_account" value="">
        <button type="submit" class="btn {{ request('bank_account') == '' ? 'btn-dark' : 'btn-outline-dark' }}">
            كل البنوك
        </button>
    </form>
    ...
    @php
    $banks = [
    'شركة الجواب - بنك الراجحي',
    'شركة الجواب - بنك الرياض',
    'الراجحي - ابو احمد',
    'الراجحي - ابو طلال',
    'مؤسسة الجواب - بنك الراجحي',
    ];
    @endphp

    @foreach ($banks as $bank)
    <form method="GET" action="{{ route('getPointAndBank') }}">
        <input type="hidden" name="bank_account" value="{{ $bank }}">
        <button type="submit" class="btn {{ request('bank_account') == $bank ? 'btn-primary' : 'btn-outline-primary' }}">
            {{ $bank }}
        </button>
    </form>
    @endforeach
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <!-- <a href="{{ route('snds.byDateBankAndPoint', $formattedMonth) }}" class="btn btn-primary btn-sm">عرض</a> -->
                                <a href="{{ route('snds.byDateBankAndPoint', $formattedMonth) }}?bank_account={{ request('bank_account') }}" class="btn btn-primary btn-sm">عرض</a>
