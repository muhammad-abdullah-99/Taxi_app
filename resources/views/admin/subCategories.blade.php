                                    ...
                                    <div class="modal fade" id="edit{{$category->id}}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <form action="{{route('updateSubCategory',$category->id)}}" method="post" enctype="multipart/form-data">
                                                        @csrf
                                                        <label style="font-size: 15px; font-weight: bold;">SubCategory Name</label>
                                    ...
                                    <div class="modal fade" id="delete{{$category->id}}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                ...
                                                <form action="{{route('deleteSubCategory',$category->id)}}" method="post">
                                                    @csrf
                                                    <h4 class="modal-body">
