...
<div class="page-title">
    <div class="row">
        <div class="col-sm-6">
            <h4 class="mb-0"> قائمة ارشيف السائقين </h4>
        </div>
        <div class="col-sm-6">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <button class="btn btn-info btn-sm" data-toggle="modal" data-target="#archive{{$driver->id}}">
                                        <i class="fa fa-undo"></i>
                                    </button>

                                    <button class="btn btn-danger btn-sm" data-toggle="modal" data-target="#delete{{$driver->id}}">
                            ...
                            <div class="modal fade" id="archive{{ $driver->id }}" tabindex="-1" aria-hidden="true">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <form action="{{ route('unarchiveDriver', $driver->id) }}" method="post">
                                            @csrf
                                            <h4 class="modal-body">هل أنت متاكد علي الغاء ارشيف السائق؟؟</h4>
                            ...
                            <!-- // delete -->
                            <div class="modal fade" id="delete{{ $driver->id }}" tabindex="-1" aria-hidden="true">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h5 class="modal-title"> استبعاد السائق </h5>
                                        ...
                                        <form action="{{ route('deleteDriver', $driver->id) }}" method="post">
                                            @csrf
                                            <h4 class="modal-body">هل أنت متاكد من حذف السائق؟؟</h4>
                                            <div class="modal-footer">
                                                <button type="button" class="btn btn-secondary" data-dismiss="modal">إغلاق</button>
                                                <button type="submit" class="btn btn-danger">موافقة</button>
                                            </div>
