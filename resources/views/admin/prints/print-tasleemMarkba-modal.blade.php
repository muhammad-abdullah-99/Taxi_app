        ...
        <form method="GET" action="{{ route($route) }}">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <label>الرقم القادم لتغير الزيت </label>
                        <input type="text" name="zyt_number" class="form-control"  required>
                    </div>
                        <div class="form-group">
                        <label> المبلغ اليومي للسيارة   </label>
                        <input type="text" name="day_cost" class="form-control"  required>
                    </div>
