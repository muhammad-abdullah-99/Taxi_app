            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                     ...
                     <div class="form-group">
                        <label> سبب الاعادة  </label>
                        <input type="text" name="reason" class="form-control"  required>
                    </div>
                      <div class="form-group">
                        <label> رقم العداد عند تغير الزيت </label>
                        <input type="text" name="adad_zayt" class="form-control"  required>
                    </div>
                   

                    <div class="form-group">
                        <label> رقم العداد الحالي </label>
                        <input type="text" name="adad_number" class="form-control"  required>
                    </div>
                    
                    <div class="form-group">
                        <label>رقم جهاز نقاط البيع</label>
                        <input type="text" name="nqt_number" class="form-control"  required>
                    </div>
                    
                    
                     <div class="form-group">
                        <label>تاريخ تغير الزيت  </label>
                        <input type="date" name="zyt_date" class="form-control" required>
                    </div>
                        <div class="form-group">
                        <label> رقم الفاتورة   </label>
                        <input type="text" name="reset_number" class="form-control"  required>
                    </div>
                          <div class="form-group">
